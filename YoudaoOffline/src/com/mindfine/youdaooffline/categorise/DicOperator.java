...
public class DicOperator {
	...
	static {
		try {
			idxout = new PrintWriter(new FileWriter(System.getProperty("user.dir") + "/youdaocollins.idx"));
			expout = new PrintWriter(new FileWriter(System.getProperty("user.dir") + "/youdaocollins.exp"));
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
